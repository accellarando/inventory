<?php
	...
	$store = mysqli_real_escape_string($conn,$_POST['storenum']);
	$dept = mysqli_real_escape_string($conn,$_POST['dept']);
	$query = "delete from scanned where store=$store AND dept=$dept";
	...
	<body>
		...
		<div class=\"contain\">
			<p style=\"font-size: 18px; text-align:center;\">The database has been successfuly cleared for store $store, department $dept. 
			<br><br>
