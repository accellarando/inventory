<?php
	...
	$_SESSION["scan-type"] = "vendorstylenum";
	...
	<?php
		...
		foreach($keys as $key){
			...
			if(in_array($key, $descriptionKeys)){
				...
				$query = "SELECT (description) FROM apple WHERE vendorStyleNum = '".$key."';";
