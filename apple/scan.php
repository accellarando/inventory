...
<body>
	<div id="title" class="contain">
		<span class="textcenter" id="titleText">
			<h1><strong>Scanning</strong> Page</h1>
		</span>
	</div>
	<div class="contain">
	...
	<div class="contain" style="height: 230px;">
		<br><br>
		<a href="sku.php"><input class="button textcenter center" style="width: 180px; margin: 0 auto;" value="Input SKU" tabindex="13" readonly /></a><br><br>
		<a href="stylenum.php"><input class="button textcenter center" style="width: 180px; margin: 0 auto;" value="Input Vendor Style Number" tabindex="13" readonly /></a><br><br><br>
    </div>
